...
class RecyclerAdapter(contexts: Context,listdata: List<Reddi>) :
    RecyclerView.Adapter<RecyclerAdapter.ViewHolder>(){
    private val listdata: List<Reddi>
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val Reddi: Reddi = listdata[position]
        holder.textView.setText(listdata[position].cat_name)
        ...
        holder.relativeLayout.setOnClickListener { view ->
            ...
            val i : Intent = Intent(contexts, BaseActivity::class.java)
